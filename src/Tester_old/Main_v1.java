...
//        if (CompareFactory. print_enable) System.out.println(getValue(s,"table"));
//        if (CompareFactory. print_enable) System.out.println(getValue(s,"id"));
//    }
//    @Test
...
//        test.add("a");
//        test.add("b");
//        //if (CompareFactory. print_enable) System.out.println(test.toString());
//    }
